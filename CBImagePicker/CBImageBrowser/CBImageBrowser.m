...
- (void)presentFromImageView:(UIView *)fromView
    ...
    [_scrollView scrollRectToVisible:CGRectMake(_scrollView.sizeWidth * _scrollView.pageControl.currentPage, 0, _scrollView.sizeWidth, _scrollView.sizeHeight) animated:NO];
